...
{
# validation stats
    r<-fromJSON(paste0('model_',m,'_ref_long/log_0_8.json'))
    val<-r$validation
...
png("online_validation_testing.png", width=20, height=10, res=200, units = "in", pointsize = 12, type='cairo', antialias = "default")
